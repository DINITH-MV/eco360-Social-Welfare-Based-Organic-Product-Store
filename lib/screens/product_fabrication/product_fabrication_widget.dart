...
class _ProductFabricationWidgetState extends State<ProductFabricationWidget> {
  ...
  void initState() {
    ...
    _model.productColourTextController ??= TextEditingController();
    _model.productColourFocusNode ??= FocusNode();
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.productColourTextController,
                                        focusNode:
                                            _model.productColourFocusNode,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.email],
                                        readOnly: true,
                                        obscureText: false,
                                        ...
                                        validator: _model
                                            .productColourTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
