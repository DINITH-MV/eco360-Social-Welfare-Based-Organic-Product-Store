...
export 'collections_page_model.dart';

class CollectionsPageWidget extends StatefulWidget {
  const CollectionsPageWidget({
    super.key,
  ...
  @override
  State<CollectionsPageWidget> createState() => _CollectionsPageWidgetState();
}

class _CollectionsPageWidgetState extends State<CollectionsPageWidget> {
  late CollectionsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CollectionsPageModel());
              ...
              Container(
                ...
                child: StreamBuilder<CatogoriesRecord>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final listViewCatogoriesRecord = snapshot.data!;
                              ...
                              child: Padding(
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text: listViewCatogoriesRecord.name,
